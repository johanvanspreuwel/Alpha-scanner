...
SP500 = [
    ...
    "MMB","AON","WTW","BRO","ACGL","RLI","MKL","HCI","ERIE","UVE","KMPR",
    "DVA","UHS","HCA","THC","CNC","MOH","CVS","WAB","CSX","KSU","R","JBHT",
    "CHRW","EXPD","XPO","SAIA","ODFL","WERN","HUBG","FWRD","MRTN","CVLG",
    "VZ","T","TMUS","LUMN","ATUS","DISH","CABO","CHTR","CMCSA","DIS","PARA",
    "FOX","FOXA","WBD","NWSA","NWS","NYT","GCI","MDP","IAC","Z","TRIP",
    "EXPE","BKNG","PCLN","HLT","MAR","H","IHG","CHH","VAC","TNL","RCL",
    "CCL","NCLH","MGM","WYNN","LVS","CZR","PENN","DKNG","ACMR","EVRI",
    "AES","AEE","AEP","AWK","D","DTE","ED","EIX","ETR","ES","EXC","FE",
    "LNT","NI","OGE","PNW","PPL","SCCO","SRE","WEC","XEL","CNP","CMS",
    "EVRG","OGS","NWN","SJW","MSEX","AWR","ARTNA","YORW","CTWS","GWRS",
    "ADM","BG","DAR","INGR","MOS","CF","NTR","FMC","CTVA","ICL","SMG",
    "AGCO","CNH","DE","CNHI","KUHN","TTC","ALAMO","GRACO","ITT","IDEX",
    "PH","ROK","EMR","HUBB","NDSN","AME","GNRC","ROP","IEX","XYL","WTS",
    "A","FTV","TRMB","MKS","KEYS","GRMN","FLIR","LII","JCI","CARR","OTIS",
    "IR","TT","MAS","PNR","ALLE","AOS","FBHS","SWK","SNA","TOOL","LDOS",
    "SAI","SAIC","DXC","HPQ","HPE","NTAP","SWKS","QRVO","TER","LLTC","MXIM",
    "XLNX","ALTR","ATVI","EA","TTWO","ZYNGA","RBLX","U","MTCH","BMBL","SNAP",
    "PINS","TWTR","RDN","MTG","ESNT","NMIH","HASI","LADR","GPMT","RC","ACRE",
    "ARI","BXMT","KREF","MFA","NLY","AGNC","TWO","CIM","IVR","EFC","WMC",
    "NYMT","ORC","ARR","CHMI","MITT","ANH","PMT","NREF","KBWY","MORT",
]

# ── S&P 400 MidCap (sample — most liquid) ────────────────────────────────────
SP400_MIDCAP = [
    "ACHC","ACM","ACLX","AEO","AGCO","AIRC","AIT","AIZ","ALE","ALK",
    "ALLE","AMCX","AMD","AMRC","AMRS","ANF","ANIK","APLE","APOG","ARI",
    ...
    "CHEF","CHX","CINF","CIR","CIVI","CKH","CLFD","CLH","CLS","CLW",
    "CMC","CMO","CNK","CNO","CODI","COIN","COLB","CPK","CRGY","CRI",
    "CRK","CRS","CSL","CSVI","CTRE","CUBE","CUZ","CVE","CVLT","CVU",
    "CWEN","CWK","CWT","CXM","CXW","DAN","DCOM","DEN","DIOD","DNB",
    "DRH","DRVN","DSP","DVN","DY","EAT","EBC","EGRX","EIGI","ELF",
    "ELS","EME","ENOV","ENSG","ENV","EPC","EPRT","ESE","ESRT","ETH",
    "EWBC","EXEL","EXP","EXPI","FAF","FBMS","FBP","FELE","FF","FFG",
    "FGEN","FISI","FL","FLGT","FLO","FR","FUL","FULT","GATX","GBX",
    "GCI","GEO","GEOS","GFF","GKOS","GMS","GNL","GPRE","GTN","GTY",
    "GVA","HAE","HALO","HBI","HCI","HCSG","HHC","HLX","HMST","HOMB",
    "HOPE","HP","HRLY","HXL","IBP","IDCC","IIIN","IIIV","IMKTA","INGR",
    ...
    "PHM","PK","PLXS","PNFP","PNM","POLY","POWL","PPBI","PPBI","PRFT",
    "PRGO","PRK","PSB","PTC","PTEN","PUMP","PVH","RDNT","REG","REZI",
    "RMBS","RNR","ROIC","RPM","RRX","RSS","RUSHA","RUSS","RXO","SAIA",
    "SAM","SBOW","SCI","SGMS","SHO","SITE","SIX","SKYW","SLG","SM",
    "SMBC","SMPL","SNEX","SONO","SPB","SPSC","SR","STC","STEL","STLD",
    "STR","STRL","SUM","SUN","SUPN","SWM","SWX","SXT","TAL","TBBK",
    ...
    "VVV","WAFD","WBS","WDFC","WEN","WERN","WEX","WH","WIFI","WKC",
    "WOR","WRE","WSC","WSR","WTFC","WWW","XNCR","XRX","YOU","ZD","ZI",
]

# ── AEX (Amsterdam) ──────────────────────────────────────────────────────────
AEX = [
    "ASML.AS","HEIA.AS","RDSA.AS","ING.AS","PHIA.AS","ADYEN.AS","NN.AS",
    "DSM.AS","AKZA.AS","MT.AS","ABN.AS","AGN.AS","LIGHT.AS","RAND.AS",
    "WKL.AS","KPN.AS","BESI.AS","IMCD.AS","AHOLD.AS","RP.AS","VPK.AS",
    "URW.AS","DSFIR.AS","GLPG.AS","BE.AS","TKWY.AS","UMG.AS","WDP.AS",
]
...
NASDAQ100_EXTRA = [
    "ADSK","ALGN","ALXN","ANSS","ASML","ATVI","BIDU","BIIB","BMRN",
